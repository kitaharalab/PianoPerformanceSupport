...
public class Keyboard {
    ...
    // private float keyboardY; // 鍵盤のY座標
    private int numKeys = 88;
    private int firstNn = 21;

    private float whiteKeyWidth, whiteKeyHeight, blackKeyWidth, blackKeyHeight, keyboardY, offsetRatio, octaveWidth, offset;
    ...
    public Keyboard(float displayWidth, float displayHeight, int numKeys, int firstNn) {
        ...
        this.keyboardY = displayHeight - this.whiteKeyHeight;
    ...
    static boolean isWhiteKey(int nn) {
        int noteInOctave = nn % 12;
