...
//             PDDocument document = PDDocument.load(is)) {
//            PDFRenderer renderer = new PDFRenderer(document);
//            BufferedImage fullImage = renderer.renderImageWithDPI(0, 10); // 150dpiの画像に変換
//
//            int width = fullImage.getWidth();
//            int height = fullImage.getHeight();
//            int partWidth = width / 10;
//            BufferedImage[] parts = new BufferedImage[10];
//
//            for (int i = 0; i < 10; i++) {
//                int x = i * partWidth;
//                int w = (i == 9) ? width - x : partWidth; // 最後の部分は端数も含める
//                parts[i] = fullImage.getSubimage(x, 0, w, height);
//            }
//            return parts;
//        }
//    }
